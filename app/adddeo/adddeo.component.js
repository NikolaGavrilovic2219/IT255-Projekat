System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AddDeoComponent = (function () {
                function AddDeoComponent(builder, http, router) {
                    this.http = http;
                    this.router = router;
                ...
                AddDeoComponent.prototype.onAddDeo = function () {
                    var _this = this;
                    ...
                    this.http.post('http://localhost/php/adddeoservice.php', data, { headers: headers })
                        ...
                        _this.router.parent.navigate(['./AllDelovi']);
                    });
                };
                AddDeoComponent = __decorate([
                    core_1.Component({
                        selector: 'AddDeo',
                ...
                return AddDeoComponent;
            }());
            exports_1("AddDeoComponent", AddDeoComponent);
        }
    }
});
//# sourceMappingURL=adddeo.component.js.map