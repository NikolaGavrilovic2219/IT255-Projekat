System.register(['angular2/core', 'angular2/common', 'angular2/http', 'rxjs/Rx', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            AllDeloviComponent = (function () {
                function AllDeloviComponent(builder, http, router) {
                    var _this = this;
                    this.http = http;
                    this.router = router;
                ...
                return AllDeloviComponent;
            }());
            exports_1("AllDeloviComponent", AllDeloviComponent);
        }
    }
});
//# sourceMappingURL=alldelovi.component.js.map